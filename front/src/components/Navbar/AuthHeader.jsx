...
export default function AuthHeader() {
  ...
  return (
    <>
      <header className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-7 md:hidden" style={HEADER_STYLE}>
      ...
      <header className="absolute top-0 left-0 right-0 z-20 hidden md:flex items-center justify-between px-8 lg:px-16 xl:px-32 py-6" style={HEADER_STYLE}>
